...
screen = pygame.display.set_mode(WINDOW_SIZE,600,400) # initiate the window
...
while True: # game loop
    ...
    true_scroll[0] += (player.x-true_scroll[0]-100)/5
    true_scroll[1] += (player.y-true_scroll[1]-120)/5
